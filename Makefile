#############################################################################
# Makefile for building: syncer
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  syncer.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile syncer.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = syncer1.0.0
DISTDIR = /home/vrmiguel/syncer/.tmp/syncer1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)    
AR            = ar cqs
...
Makefile: syncer.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
